...
public class DirectedInducedSubgraph<V, E> extends DefaultDirectedGraph<V, E> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2857224315157299929L;

	private DefaultDirectedGraph<V, E> G;
	private Set<V> V;

	private Set<E> edgeSet;

	public DirectedInducedSubgraph(DefaultDirectedGraph<V, E> G, Set<V> V, Class<E> edgeClass) {
		super(edgeClass);
		this.G = G;
		this.V = V;
	}
	...
	public Set<E> edgesOf(V vertex) {
		return G.edgesOf(vertex).stream().filter(e -> V.contains(Graphs.getOppositeVertex(G, e, vertex)))
	...
	public Supplier<V> getVertexSupplier() {
		return G.getVertexSupplier();
	}

	@Override
	public Supplier<E> getEdgeSupplier() {
		return G.getEdgeSupplier();
	}
