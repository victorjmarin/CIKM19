...
public class PDGBuilderConfig {
	...
	private boolean keepLines, removeComments, removeImports, interproceduralCalls;
	...
	public String toString() {
		return String.format("[originalLines=%s, interproceduralCalls=%s]", keepLines, interproceduralCalls);
	}
